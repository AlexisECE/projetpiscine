    ...
    <body> 
        <div class="container">
            <nav class="navbar navbar-expand">
              <a class="navbar-brand" href="index.php"><img src="poire2.png" alt="logo" width="120px" height="60px"/></a>
          ...
          <div class="collapse navbar-collapse" id="main-navigation">
            ...
            <a1 class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Mon compte</a1>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="ferraille.html">blabla</a>
                  <a class="dropdown-item" href="infoperso.html">Mes informations personnelles</a>
                ...
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                      <img class="d-block img-fluid" src="covid.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block img-fluid" src="banniere.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block img-fluid" src="fond1.png" alt="Third slide">
                    </div>
                  </div>
