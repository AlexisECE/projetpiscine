...
<html>
    ...
    <body> 
                                ...
                                <form action="inscriptions.php" method="post">
                                    <table>
                                         <tr>
                                            ...
                                            <td><input type="text" name="prenom" placeholder="Prénom" size="38px"></td> 
                                        </tr>
                                        <tr>
                                            <td><input type="text" name="nom" placeholder="Nom" size="38px"></td> 
                                        </tr>
                                        <tr>
                                            <td><input type="email" name="email" placeholder="Adresse e-mail" size="38px"></td> 
                                        </tr>
                                       
                                        <tr>
                                            <td><input type="password" name="mdp" placeholder="Mot de passe" size="38px"></td> 
                                        </tr> 

                                        <tr>
                                            <td><small><br>En cliquant sur <b>S'inscrire</b>, vous confirmez avoir lu et accepté les <a href= condition.html ><u>Conditions d'utilisation</u> </a>. Veuillez vous référer à notre <a href= avis.html ><u>Avis sur les données personnelles</u> </a> pour toute information concernant le traitement de vos données.</small>
                                                <br><br></td>
                                        </tr>
        ...
        <input type="submit" name="button" value="S'inscrire"></td>
